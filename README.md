...
- The notebook shows how the external evalution sets have a Tanimoto Similarity of less than 70%
	<p align="center">
		<img src="images/hERG_eval_set_Tanimoto_Similarity_distribution.png" width="400" height="320" />
	</p>
- And prediction results using the inference pipelines as well as the evaluation metrics
	<p align="center">
		<img src="images/hERG_eval_set_confusion_matrix.png" width="400" height="320" />
	</p>
